...
class Sam2Infer:
  ...
  def __init__(self,args):
      ...
      print(self.mappingway,type(self.mappingway))
  def run(self):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--sam2_PathLib", type=str, default='/kaggle/input/datasets/telakerk/sam2lib/mylibs/', help="Path for Sam2 Lib.")
    parser.add_argument("--sam2_PathModel", type=str, default='/kaggle/input/datasets/hubarera/footlib-v0/magalib/sam2.1_hiera_large.pt', help="Path for sam2 model.")
    parser.add_argument("--sam2_PathConfig", type=str, default='/kaggle/input/datasets/telakerk/sam2lib/mylibs/sam2/configs/sam2.1/sam2.1_hiera_l.yaml', help="Path for sam2 Config.")
